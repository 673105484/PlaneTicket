<%@page import="com.ljn.dao.FlightCompanyDao"%>
<%@page import="com.ljn.model.FlightCompany"%>
...
<body>
    ...
    %>
			...
			<div class="info info_middle">
				<li><b>公司名</b>&nbsp <b>地址</b>&nbsp<em>电话</em> &nbsp <em>邮箱</em></li>
				<%
    
     
      FlightCompany fc=new FlightCompany();
     FlightCompanyDao fcd=new FlightCompanyDao();
     List<FlightCompany> list2= fcd.query();
     if(list2!=null&&list2.size()>0){
     for(int i=0;i<list2.size();i++){
    %>
				<ul>
					<li><b><%=list2.get(i).getCname() %></b>&nbsp <b><%=list2.get(i).getCaddress()%></b>&nbsp<em><%=list2.get(i).getPhone()%></em><em><%=list2.get(i).getCmail()%></em>>
					</li>
				</ul>
				<%
          }
